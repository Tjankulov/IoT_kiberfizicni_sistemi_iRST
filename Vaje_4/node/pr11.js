// Povezava_klient_strežnik_modul esp32_tipka (canvas)
...
app.get("/", (req, res) => {
    res.sendFile(join(_dirname, "pr11.html")); // pošlje datoteko pr07.html kot odgovor na zahtevo ("request - response")
});
