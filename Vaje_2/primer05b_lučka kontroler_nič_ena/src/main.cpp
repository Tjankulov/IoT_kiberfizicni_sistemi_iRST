...
// KAR JE ZNOTRAJ 'SETUP' - izvedeno enkrat ob vklopu
// KAR JE ZNOTRAJ 'LOOP' - izvajanje ciklično z maksimalno možno hitrostjo
// procesor dela s hitrostjo 340 MHz, kar pomeni, da lahko v eni sekundi izvede 340 milijonov ukazov, če so ti ukazi zelo preprosti, sicer pa manj, odvisno od zahtevnosti ukazov

// tako lahko npr dostopamo do modula tudi preko telefona
// na to nožico bi lahko npr priključili relayski modul in bi lahko prižgali in ugasnili napravo
// ključen mehanizem 0 in 1

// delovalo bi tudi 1 ali true in pa 0 ali false

// gpio - general purpose input/output

// če bi priklopili na baterijo, je to potem samostojna naprava in računalnika ne potrebujemo več
